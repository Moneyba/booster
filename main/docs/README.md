...
![aws account menu location](docs/img/aws-account-menu.png)
...
![create access key button location](docs/img/aws-create-access-key.png)

A pop-up like the following will appear, **don't close it!**. 

![credentials pop up](docs/img/aws-credentials.png)
...
![resources](docs/img/aws-resources.png)
...
![architecture](docs/img/booster-arch.png)
...
![reducer process gif](docs/img/reducer.gif)
...
![hoppscotch screenshot](docs/img/postwoman-screenshot.png)
